...
input=paper #input filename prefix
output=paper #output filename prefix
format=pdf  #extension of the output filename to generate
outputdir=papertmp #directory where auxiliary files are saved to
redirect=1 #write to stdout (by default there is no redirection)
