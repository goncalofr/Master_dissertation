...
O \emph{software} de controlo do \ac{ROVIM} instalado no microcontrolador pode ser comandado através de duas interfaces: a interface série e a interface \ac{I2C}.
...
\begin{center}
    \begin{tabular}{@{} m{0.2\textwidth} m{0.6\textwidth}}
        ...
        \textsf{G17 56}$\vrectangleblack$ & Vira tudo a bombordo\\
